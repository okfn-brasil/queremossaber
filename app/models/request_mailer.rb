...
class RequestMailer < ApplicationMailer
    ...
    # trip via the mail parser, or by bugs in it, and so we can use some other parser
    # at a later date. And so we can offer an option to download the
    ...
    def self.receive(raw_email)
        ...
        mail = MailParsing.mail_from_raw_email(raw_email)
